# Aryavarta Industrial Resources Website

Static multi-page website for Aryavarta Industrial Resources Private Limited.
...
Upload the contents of this folder to a GitHub repository and enable GitHub Pages from the repository root. The site is dependency-free and does not require a build step.

The employee login is a static front-end demo. For production use, connect it to a secure backend authentication service before storing or displaying real employee data.
